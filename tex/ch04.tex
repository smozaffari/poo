...
\caption[Opposite effect eQTLs driven by one individual's genotype.]{\textbf{Opposite effect eQTLs driven by one individual's genotype.} The three most significant opposite effect eQTLs for genes A) \emph{TIGD5} (p-value 3.1e-09), B) \emph{SON} (p-value 4.3e-09) and C) \emph{CDCA5} (p-value 3.5e-09). The parent of origin eQTL is driven by one individual with a heterozygote genotype for each gene.}
\label{fig:oeQTL}
\end{figure}
\clearpage
